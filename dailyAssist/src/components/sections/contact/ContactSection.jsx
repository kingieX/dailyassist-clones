...
export default function ContactSection() {
 ...
 {/* Rectangle 1 — pink/salmon, top right */}
  <img
    ...
    loading="lazy" alt=""
    className="hidden md:block absolute top-0 right-0 w-64 rotate-12 opacity-80 z-0"
  />
  ...
  src="/Images/Rectangle8 green.png"
    loading="lazy" alt=""
    className="absolute bottom-52 right-0 w-56 rotate-6 opacity-80 -z-10 md:z-0"
  />
        {/* Main Grid */}
  ...
  loading="lazy" alt=""
  className="absolute bottom-[-5px] left-[125px] w-[150px] md:left-40 md:w-64 opacity-90 z-0"
  style={{ transform: "rotate(-1deg)" }}
/>
            </div>

            <p className="text-gray-600 text-lg mb-10 max-w-md leading-relaxed">
              We're happy to answer your questions, discuss your needs, or help you book
              a free consultation.
            </p>
