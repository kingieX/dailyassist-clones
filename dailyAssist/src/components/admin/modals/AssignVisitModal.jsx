...
// export default function AssignVisitModal({ isOpen, onClose }) {
...
//   const [note, setNote]             = useState("Provided home-help support during the scheduled visit, including light cleaning and general assistance. Client was calm and in good spirits throughout the visit. No concerns observed, and the home environment was safe and tidy. No follow-up actions required at this time.");
...
//             <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Assign visit</h2>
//           </div>
...
//               <label className="text-sm font-medium text-gray-700 flex-1">Client's Name <span className="text-red-500">*</span></label>
//             </div>
//             <div className="flex gap-2">
//               <select value={title} onChange={(e) => setTitle(e.target.value)}
//                 className="w-20 border border-gray-200 rounded-xl px-3 py-3 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-blue-200 bg-white flex-shrink-0">
//                 {titleOptions.map(t => <option key={t}>{t}</option>)}
//               </select>
//               <input type="text" value={clientName} onChange={(e) => setClientName(e.target.value)}
//                 placeholder="Alan Sarah"
//                 className="flex-1 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-blue-200" />
//             </div>
//           </div>
...
//                   className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-blue-200 pr-10" />
...
//             <div className="flex flex-col gap-1.5">
//               <label className="text-sm font-medium text-gray-700">Assign Staff <span className="text-red-500">*</span></label>
//               <div className="relative">
...
//             </div>
//             <div className="flex flex-col gap-1.5">
//               <label className="text-sm font-medium text-gray-700">Package <span className="text-red-500">*</span></label>
//               <div className="relative">
...
//                   <input type="checkbox" checked={selectedServices.includes(type)}
...
//                 <label key={type} className="flex items-center gap-3 text-sm text-gray-700 cursor-pointer">
//                   <input type="checkbox" checked={selectedAdditional.includes(type)}
...
//               className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-600 outline-none focus:ring-2 focus:ring-blue-200 resize-none" />
//           </div>
//         </div>
...
//                        px-8 py-8 flex flex-col items-center gap-4 text-center"
//             onClick={(e) => e.stopPropagation()}
//           >
//             <h2 className="text-xl font-bold text-gray-900">Assign this visit?</h2>
//             <p className="text-sm text-gray-500 leading-relaxed">
//               This visit will be assigned to the selected staff.
//               They'll be notified and the schedule will update automatically.
//             </p>
...
//                            hover:bg-blue-600 text-white font-semibold text-sm
//                            transition-colors"
//               >
//                 Yes, Assign Visit
//               </button>
...
export default function AssignVisitModal({ isOpen, onClose, editMode = false, prefillData = {} }) {
  const [title, setTitle]           = useState("Mrs.");
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 sm:px-8 pt-6 pb-4 border-b border-gray-100">
            <div className="flex items-center gap-3">
             ...
             <h2 className="text-xl sm:text-2xl font-bold text-gray-900">
              {editMode ? "Edit visit" : "Assign visit"}
            </h2>
            </div>
            <button onClick={onClose} className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors">
              <X className="w-5 h-5 text-gray-600" />
          ...
          <button onClick={() => setShowConfirm(true)}
              className="w-full flex items-center justify-center gap-2 py-4 rounded-xl
                         ...
                         text-white transition-all duration-200">
              <Calendar className="w-5 h-5" />
              {editMode ? "Save Changes" : "Assign Visit"}
            </button>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="flex gap-3 w-full mt-2">
              ...
              <button onClick={handleSubmit}
               ...
               {editMode ? "Yes, Save Changes" : "Yes, Assign Visit"}
              </button>
            </div>
          </div>
        </div>
